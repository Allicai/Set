...
/**
 * class to test methods for the SetThreeGameModel class.
 */
public class SetThreeGameModelTest {

  ASetGameModel game = new SetThreeGameModel();
  ...
  @Test
  public void testSetClaimWithInvalidSet() { // exception is thrown and no points added
    genDeck1();
  ...
  @Test
  public void testInsufficientDeck() { //
    this.deck.add(c1);
    this.deck.add(c2);
    this.deck.add(c3);
    try {
      game.startGameWithDeck(this.deck, 3, 3);
      fail("Deck size too small.");
    } catch (IllegalArgumentException e) {
      // do nothing
    }
  }
  ...
  @Test
  public void testSingleSetGameOver() { //makes sure the game is ending properly
    this.deck.add(c19);
    this.deck.add(c12);
    this.deck.add(c1);
    this.deck.add(c18);
  ...
  @Test
  public void testMakeGridValidHeightAndWidth() { // makes sure the 3 by 3 board renders properly
